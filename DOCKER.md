...
> The legacy `beibeiru/RidgeR` package is archived and no longer installed. See [docs/installation.md](docs/installation.md#native-r-install-linux-macos-windows) for native install instructions on Linux/macOS/Windows.
